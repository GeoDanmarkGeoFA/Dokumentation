...
Man kan i GeoFA styre, hvilke typer af brugere som må se de data, man læger ind. Dette gøres ved at sætte en værdi i feltet *off_kode*. 
...
Man man ved at sætte offentlighedskoden styre, hvem der kan se elementerne. Dette kan eksempelvis bruges til at styre data i forbindelse med en kvalitetssikringsproces.
...
Når kommunerne efterfølgende har arbejdet med data (kvalificeret dem, kontrolleret ruteforløb mv.), overtager kommunerne data og gør dem synlige for omverdenen ved at ændre følgende:
